...
emm <- emmeans(model_reduced, ~ Group | Months, at = list(Months = c(1, 6)) ) # but no interaction so same results for Groups
confint(contrast(emm, method = "revpairwise"), level = 0.95)
# (-0.25 increase, 95% CI -0.906,0.405, p = 0.768) 

emm <- emmeans(model_reduced, ~ Group) # same results as above
confint(contrast(emm, method = "revpairwise"), level = 0.95)
# contrast           estimate    SE   df lower.CL upper.CL
# CLAD - (CLAD-free)    -0.25 0.323 34.8   -0.906    0.405
```
...
confint(contrast(emm, method = "revpairwise"), level = 0.95)
# contrast           estimate    SE   df lower.CL upper.CL
# CLAD - (CLAD-free)  -0.0603 0.227 42.8   -0.519    0.399
