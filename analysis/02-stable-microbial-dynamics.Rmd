---
title: "Figure 2: Stable cohort - Microbioal dynamics post-transplant"
...
plot_ordination(data, ord) + 
  ...
  geom_point(aes(fill = Months_grouped), shape = 21) + 
  theme +
  theme(legend.position = "none",
...
ggsave(paste0(analysis_path, "microbial-dynamics/fungi-pcoa-interval.pdf"), p, width = 13, height = 7, units = 'cm', dpi = 600)
```
