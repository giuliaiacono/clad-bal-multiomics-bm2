...
# bact.raw <- readRDS(paste0(preprocessing_path, "Microbiome/Data/16S/bact.raw.rds"))
...
ggplot(bact.ctrls.filt, aes(x=Abundance, y=SampleID)) + 
...
# bact.filt <- readRDS(paste0(preprocessing_path, "Microbiome/Data/16S/bact.filt.rds"))
...
# fungi.raw <- readRDS(paste0(preprocessing_path, "Microbiome/Data/ITS/fungi.raw.rds"))
```
...
fungi.keep <- fungi.summary %>%
  ...
  #filter(!SampleID %in% c("16S.B0003682", "16S.B0003680")) # remove R healthy lung, (left tx one is 3712)
...
fungi.filt <- readRDS(paste0(preprocessing_path, "Microbiome/Data/ITS/fungi.filt.rds"))
