...
```{r}
# Counts
nf_core_raw <- read.delim("Transcriptomics/Data/nf-core/rnaseq_output/star_salmon/counts/salmon.merged.gene_counts_length_scaled.tsv", sep = "\t", header = TRUE) 
...
biotype <- readRDS("Transcriptomics/Data/biotype.rds")
# rm(ensembl)
...
# transcriptomics_counts <- readRDS("Transcriptomics/Data/transcriptomics_counts.rds")
saveRDS(rna_metadata, "Transcriptomics/Data/rna_metadata.rds")
# rna_metadata <- readRDS("Transcriptomics/Data/rna_metadata.rds")
```
...
saveRDS(rna_corrected, "Transcriptomics/Data/rna_corrected.rds")
dim(rna_corrected) #12707   234

rm(r, nf_core_raw, dge, dge_filtered, rna_combat, transcriptomics_counts)
