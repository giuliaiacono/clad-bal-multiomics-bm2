...
write.csv(r, "sra-submission/rnaseq-samples-metadata.csv")
```
...
write.csv(r_sra, "sra-submission/rnaseq-sra-metadata.csv")
```
...
write.csv(b, "sra-submission/16s-samples-metadata.csv")
```
...
write.csv(b_sra, "sra-submission/16S-sra-metadata.csv")
```
...
write.csv(f, "sra-submission/its-samples-metadata.csv")
```
...
write.csv(f_sra, "sra-submission/its-sra-metadata.csv")
```
